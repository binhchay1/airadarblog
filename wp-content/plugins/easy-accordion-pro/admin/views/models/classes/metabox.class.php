<?php
/**
 * The metabox class functionality of the plugin.
 *
...
if ( ! class_exists( 'SP_EAP_Metabox' ) ) {
	...
	class SP_EAP_Metabox extends SP_EAP_Abstract {
		...
		public function add_meta_box_content( $post, $callback ) {
			...
			echo '<a class="btn btn-success" id="sp__eap-show-preview" data-id="' . esc_attr( $post->ID ) . '"href=""> <i class="fa fa-eye" aria-hidden="true"></i> ' . esc_html( 'Show Preview' ) . '</a>';
			...
			if ( ! empty( $this->args['show_restore'] ) ) {
				...
				echo '<span class="button eapro-button-restore">' . esc_html__( 'Restore', 'easy-accordion-pro' ) . '</span>';
				echo '<span class="button eapro-button-cancel">' . sprintf( '<small>( %s )</small> %s', esc_html__( 'update post for restore ', 'easy-accordion-pro' ), esc_html__( 'Cancel', 'easy-accordion-pro' ) ) . '</span>';
				echo '</label>';
				echo '</div>';
