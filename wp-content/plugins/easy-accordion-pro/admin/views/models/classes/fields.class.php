<?php
/**
 * The fields class functionality of the plugin.
 *
		...
		public static function field_data( $type = '', $term = false, $query_args = array() ) {
			...
			switch ( $type ) {
				...
				case 'all_posts':
					...
					$sp_selected_posts = isset( $upload_data['eap_specific_posts'] ) ? $upload_data['eap_specific_posts'] : '';
					if ( isset( $sp_selected_posts ) && ! empty( $sp_selected_posts ) ) {
						$eap_get_specific = array(
							'post_type' => $upload_data['eap_post_type'],
						);
