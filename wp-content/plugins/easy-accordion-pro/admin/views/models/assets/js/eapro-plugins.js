...
(function($) {
  ...
  function SP_EAPAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SP_EAPAjaxChosen.prototype.init = function() {
  ...
  SP_EAPAjaxChosen.prototype.events = function() {
  ...
  SP_EAPAjaxChosen.prototype.search_field_focused = function() {
  ...
  SP_EAPAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SP_EAPAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('eapro-chosen', _this.options.data).done( function( response ) {
  ...
  SP_EAPAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.eapro-hidden-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SP_EAPChosenOrder($hidden_value, true);
  ...
  $.fn.SP_EAPAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SP_EAPAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SP_EAPAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SP_EAPAbstractChosenOrder = (function() {

    function SP_EAPAbstractChosenOrder() {}

    SP_EAPAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SP_EAPAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SP_EAPAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SP_EAPAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SP_EAPAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SP_EAPAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SP_EAPAbstractChosenOrder.SP_EAPChosenOrder = function(select, order, force) {
    ...
    return SP_EAPAbstractChosenOrder;
  ...
  $.fn.extend({
    SP_EAPChosenOrder: function(order, force) {
      return _SP_EAPChosenOrder.SP_EAPChosenOrder(this, order, force);
    }
  });

  this._SP_EAPChosenOrder = (function(_super) {
    __extends(_SP_EAPChosenOrder, _super);

    function _SP_EAPChosenOrder() {
      _ref = _SP_EAPChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SP_EAPChosenOrder.relAttributeName = 'data-option-array-index';

    _SP_EAPChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SP_EAPChosenOrder.getDOMElement = function(element) {
    ...
    _SP_EAPChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SP_EAPChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SP_EAPChosenOrder;

  })(SP_EAPAbstractChosenOrder);
